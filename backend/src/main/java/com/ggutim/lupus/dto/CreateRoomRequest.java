 ...
 * gravediggers, idiots, corrupted judges, survivors, guardians, killers
 * and mayors. The remaining players are assigned the villager role.
 *
...
public record CreateRoomRequest(
        ...
        @Max(value = 1, message = "priestCount cannot be more than 1")
        Integer priestCount,

        @NotNull(message = "gravediggerCount is required")
        @Min(value = 0, message = "gravediggerCount must be at least 0")
        @Max(value = 1, message = "gravediggerCount cannot be more than 1")
        ...
        @NotNull(message = "guardianCount is required")
        @Min(value = 0, message = "guardianCount must be at least 0")
        @Max(value = 1, message = "guardianCount cannot be more than 1")
        Integer guardianCount,

        @NotNull(message = "killerCount is required")
        @Min(value = 0, message = "killerCount must be at least 0")
        @Max(value = 1, message = "killerCount cannot be more than 1")
        Integer killerCount,

        @NotNull(message = "mayorCount is required")
        @Min(value = 0, message = "mayorCount must be at least 0")
        @Max(value = 1, message = "mayorCount cannot be more than 1")
        Integer mayorCount,
