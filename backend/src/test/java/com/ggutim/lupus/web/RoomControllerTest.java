...
class RoomControllerTest {
    ...
    void createRoom_returnsCreatedRoomWithMasterToken() {
        ...
        var result = mvc.post().uri("/api/rooms")
                ...
                .content("""
                        {"gameMode":"CLASSIC","playerCount":10,"werewolfCount":3,"priestCount":1,"gravediggerCount":0,"idiotCount":0,"corruptedJudgeCount":0,"survivorCount":0,"guardianCount":0,"remoteJoin":true,"manualRoles":false}
                        """)
                .assertThat()
                .hasStatus(201);
    ...
    void createRoom_rejectsPlayerCountOutOfConfiguredRange() {
        ...
        mvc.post().uri("/api/rooms")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
                        {"gameMode":"CLASSIC","playerCount":3,"werewolfCount":1,"priestCount":0,"gravediggerCount":0,"idiotCount":0,"corruptedJudgeCount":0,"survivorCount":0,"guardianCount":0,"remoteJoin":true,"manualRoles":false}
                        """)
                .assertThat()
                .hasStatus(400);
    }
    ...
    void createRoom_acceptsPlayerCountAtMinimum() {
        ...
        mvc.post().uri("/api/rooms")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
                        {"gameMode":"CLASSIC","playerCount":4,"werewolfCount":1,"priestCount":0,"gravediggerCount":0,"idiotCount":0,"corruptedJudgeCount":0,"survivorCount":0,"guardianCount":0,"remoteJoin":true,"manualRoles":false}
                        """)
                .assertThat()
                .hasStatus(201);
    }
    ...
    void createRoom_rejectsMoreThanOneCorruptedJudge() {
        mvc.post().uri("/api/rooms")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
                        {"gameMode":"CLASSIC","playerCount":10,"werewolfCount":3,"priestCount":1,"gravediggerCount":0,"idiotCount":0,"corruptedJudgeCount":2,"survivorCount":0,"guardianCount":0,"remoteJoin":true,"manualRoles":false}
                        """)
                .assertThat()
                .hasStatus(400);
    }
    ...
    void createRoom_rejectsMoreThanOnePriest() {
        mvc.post().uri("/api/rooms")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
                        {"gameMode":"CLASSIC","playerCount":10,"werewolfCount":3,"priestCount":2,"gravediggerCount":0,"idiotCount":0,"corruptedJudgeCount":0,"survivorCount":0,"guardianCount":0,"remoteJoin":true,"manualRoles":false}
                        """)
                .assertThat()
                .hasStatus(400);
    }
    ...
    void createRoom_rejectsMoreThanOneGravedigger() {
        mvc.post().uri("/api/rooms")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
                        {"gameMode":"CLASSIC","playerCount":10,"werewolfCount":3,"priestCount":1,"gravediggerCount":2,"idiotCount":0,"corruptedJudgeCount":0,"survivorCount":0,"guardianCount":0,"remoteJoin":true,"manualRoles":false}
                        """)
                .assertThat()
                .hasStatus(400);
    }
    ...
    void createRoom_rejectsMoreThanOneGuardian() {
        mvc.post().uri("/api/rooms")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
                        {"gameMode":"CLASSIC","playerCount":10,"werewolfCount":3,"priestCount":1,"gravediggerCount":0,"idiotCount":0,"corruptedJudgeCount":0,"survivorCount":0,"guardianCount":2,"remoteJoin":true,"manualRoles":false}
                        """)
                .assertThat()
                .hasStatus(400);
    }
